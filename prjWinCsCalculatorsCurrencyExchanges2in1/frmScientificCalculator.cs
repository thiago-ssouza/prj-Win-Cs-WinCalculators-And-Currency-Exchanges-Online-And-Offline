...
namespace prjWinCsCalculatorsCurrencyExchanges2in1
{
    public partial class frmScientificCalculator : Form
    {
        ...
        const string LOG_OF_ZERO_ERROR_INVALID = "Invalid input";
        ...
        private void frmStandardCalculator_Load(object sender, EventArgs e)
        {
            ...
            btnClearEntry.Visible = false;
            btnCubeRoot.Enabled = btnYRootX.Enabled = btnLogYPowerX.Enabled = btnEPowerX.Enabled = false;
            btnCube.Visible = btnCubeRoot.Visible = btnYRootX.Visible = btnTwoPowerX.Visible = btnLogYPowerX.Visible = btnEPowerX.Visible = false;
            btnOpenParenteshis.Enabled = btnCloseParenteshis.Enabled = btnExponent.Enabled = btnFatorial.Enabled = btnLogYPowerX.Enabled = btnEPowerX.Enabled = false;
        ...
        {
            btnSecond.Enabled = btnPI.Enabled = btnE.Enabled = btnSquare.Enabled = btnOneDivideByX.Enabled = btnAbs.Enabled = btnExponent.Enabled = btnMod.Enabled = btnSquareRoot.Enabled = btnOpenParenteshis.Enabled = btnCloseParenteshis.Enabled = btnFatorial.Enabled = btnPlusMinus.Enabled = btnDecimalPoint.Enabled = btnMPlus.Enabled = btnMMinus.Enabled = btnMs.Enabled = btnDivision.Enabled = btnMultiplication.Enabled = btnSubtraction.Enabled = btnAddition.Enabled = btnXPowerY.Enabled = btnTenPowerX.Enabled = btnLog.Enabled = btnNaturalLog.Enabled = btnTwoPowerX.Enabled = btnCube.Enabled = true;

            btnSecond.ForeColor = btnPI.ForeColor = btnE.ForeColor = btnSquare.ForeColor = btnOneDivideByX.ForeColor = btnAbs.ForeColor = btnExponent.ForeColor = btnMod.ForeColor = btnSquareRoot.ForeColor = btnOpenParenteshis.ForeColor = btnCloseParenteshis.ForeColor = btnFatorial.ForeColor = btnPlusMinus.ForeColor = btnDecimalPoint.ForeColor = btnMPlus.ForeColor = btnMMinus.ForeColor = btnMs.ForeColor = btnDivision.ForeColor = btnMultiplication.ForeColor = btnSubtraction.ForeColor = btnAddition.ForeColor = btnXPowerY.ForeColor = btnTenPowerX.ForeColor = btnLog.ForeColor = btnNaturalLog.ForeColor = btnTwoPowerX.ForeColor = btnCube.ForeColor = Form.DefaultForeColor;
            btnOpenParenteshis.Enabled = btnCloseParenteshis.Enabled = btnExponent.Enabled = btnFatorial.Enabled = btnLogYPowerX.Enabled = btnEPowerX.Enabled = false;
                ...
                case "÷":
                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            btnSecond.Enabled = btnPI.Enabled = btnE.Enabled = btnSquare.Enabled = btnOneDivideByX.Enabled = btnAbs.Enabled = btnExponent.Enabled = btnMod.Enabled = btnSquareRoot.Enabled = btnOpenParenteshis.Enabled = btnCloseParenteshis.Enabled = btnFatorial.Enabled = btnPlusMinus.Enabled = btnDecimalPoint.Enabled = btnMPlus.Enabled = btnMMinus.Enabled = btnMs.Enabled = btnDivision.Enabled = btnMultiplication.Enabled = btnSubtraction.Enabled = btnAddition.Enabled = btnXPowerY.Enabled = btnTenPowerX.Enabled = btnLog.Enabled = btnNaturalLog.Enabled = btnTwoPowerX.Enabled = btnCube.Enabled = false;
                            btnSecond.ForeColor = btnPI.ForeColor = btnE.ForeColor = btnSquare.ForeColor = btnOneDivideByX.ForeColor = btnAbs.ForeColor = btnExponent.ForeColor = btnMod.ForeColor = btnSquareRoot.ForeColor = btnOpenParenteshis.ForeColor = btnCloseParenteshis.ForeColor = btnFatorial.ForeColor = btnPlusMinus.ForeColor = btnDecimalPoint.ForeColor = btnMPlus.ForeColor = btnMMinus.ForeColor = btnMs.ForeColor = btnDivision.ForeColor = btnMultiplication.ForeColor = btnSubtraction.ForeColor = btnAddition.ForeColor = btnXPowerY.ForeColor = btnTenPowerX.ForeColor = btnLog.ForeColor = btnNaturalLog.ForeColor = btnTwoPowerX.ForeColor = btnCube.ForeColor = Color.DimGray;
                            btnClear.Visible = true;
                            btnClearEntry.Visible = false;
                        }
        ...
        private void btnTenPowerX_Click(object sender, EventArgs e)
        {
            if (value1 == "" && result == "")
            {
                lblResultDisplay.Text = 10 + "^" + "(" + lblEntry.Text + ")";
                lblEntry.Text = (Math.Pow(10, Convert.ToSingle(lblEntry.Text))).ToString();
            ...
            else
            {
                if ((value1 != "" && result == ""))
                {
                    value2 = (Math.Pow(10, Convert.ToSingle(lblEntry.Text))).ToString();
                    lblResultDisplay.Text = value1 + " " + operation + " " + 10 + "^" + "(" + lblEntry.Text + ")";
                    lblEntry.Text = value2;
                ...
                else if (result != "")
                {
                    ...
                    if (entryHasChanged)
                    {
                        result = (Math.Pow(10, Convert.ToSingle(lblEntry.Text))).ToString();
                        value1 = result;
                        lblResultDisplay.Text = 10 + "^" + "(" + lblEntry.Text + ")";
                    }
                    else
                    {
                        result = (Math.Pow(10, Convert.ToSingle(result))).ToString();
        ...
        private void btnXPowerY_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                if ((value1 != "" && result == ""))
                {
                    value2 = (Math.Pow(Convert.ToSingle(lblEntry.Text), Convert.ToSingle(lblEntry.Text))).ToString();
                    lblResultDisplay.Text = lblEntry.Text + "^";
                }
        ...
        private void btnPI_Click(object sender, EventArgs e)
        {
            if (value2 != "")
            {
                lblEntry.Text = "3.1415926535897932384626433832795";
                lblResultDisplay.Text = "";
            }
            else
            {
        ...
        private void btnAbs_Click(object sender, EventArgs e)
        {
            if (value1 == "" && result == "")
            {
                ...
                lblResultDisplay.Text = "abs" + "(" + lblEntry.Text + ")";
                lblEntry.Text = (Math.Abs(Convert.ToSingle(lblEntry.Text))).ToString();
            ...
            else
            {
                if ((value1 != "" && result == ""))
                {
                    value2 = (Math.Abs(Convert.ToSingle(lblEntry.Text))).ToString();
                    lblResultDisplay.Text = value1 + " " + operation + " " + "abs" + "(" + lblEntry.Text + ")";
                    lblEntry.Text = value2;
                ...
                else if (result != "")
                {
                    ...
                    {
                            value1 = result;
                            result = (Math.Abs(Convert.ToSingle(result))).ToString();
                            lblResultDisplay.Text = value1 + " " + operation + " " + "abs" + "(" + lblEntry.Text + ")";
                            value2 = (Math.Abs(Convert.ToSingle(lblEntry.Text))).ToString();
                    }
                    else
                    {
                        if (entryHasChanged)
                        {
                            result = (Math.Abs(Convert.ToSingle(lblEntry.Text))).ToString();
                            value1 = result;
                            lblResultDisplay.Text = "abs" + "(" + lblEntry.Text + ")";
                        }
                        else
        ...
        private void btnE_Click(object sender, EventArgs e)
        {
            if (result != "" && value2 != "")
            {
                lblEntry.Text = "2.7182818284590452353602874713527";
                lblResultDisplay.Text = "";
            }
            else
            {
        ...
        private void btnLog_Click(object sender, EventArgs e)
        {
            if (value1 == "" && result == "")
            {
                if (lblEntry.Text == "0")
                {
                    result = LOG_OF_ZERO_ERROR_INVALID;
                    lblResultDisplay.Text = "log" + "(" + lblEntry.Text + ")";
                    lblEntry.Text = result;
                    btnSecond.Enabled = btnPI.Enabled = btnE.Enabled = btnSquare.Enabled = btnOneDivideByX.Enabled = btnAbs.Enabled = btnExponent.Enabled = btnMod.Enabled = btnSquareRoot.Enabled = btnOpenParenteshis.Enabled = btnCloseParenteshis.Enabled = btnFatorial.Enabled = btnPlusMinus.Enabled = btnDecimalPoint.Enabled = btnMPlus.Enabled = btnMMinus.Enabled = btnMs.Enabled = btnDivision.Enabled = btnMultiplication.Enabled = btnSubtraction.Enabled = btnAddition.Enabled = btnXPowerY.Enabled = btnTenPowerX.Enabled = btnLog.Enabled = btnNaturalLog.Enabled = btnTwoPowerX.Enabled = btnCube.Enabled = false;
                    btnSecond.ForeColor = btnPI.ForeColor = btnE.ForeColor = btnSquare.ForeColor = btnOneDivideByX.ForeColor = btnAbs.ForeColor = btnExponent.ForeColor = btnMod.ForeColor = btnSquareRoot.ForeColor = btnOpenParenteshis.ForeColor = btnCloseParenteshis.ForeColor = btnFatorial.ForeColor = btnPlusMinus.ForeColor = btnDecimalPoint.ForeColor = btnMPlus.ForeColor = btnMMinus.ForeColor = btnMs.ForeColor = btnDivision.ForeColor = btnMultiplication.ForeColor = btnSubtraction.ForeColor = btnAddition.ForeColor = btnXPowerY.ForeColor = btnTenPowerX.ForeColor = btnLog.ForeColor = btnNaturalLog.ForeColor = btnTwoPowerX.ForeColor = btnCube.ForeColor = Color.DimGray;
                    btnClear.Visible = true;
                ...
                {
                    lblResultDisplay.Text = "log" + "(" + lblEntry.Text + ")";
                    lblEntry.Text = Math.Log10(Convert.ToSingle(lblEntry.Text)).ToString();
                }
            ...
            else
            {
                if ((value1 != "" && result == ""))
                {
                    ...
                    {
                        value2 = Math.Log10(Convert.ToSingle(lblEntry.Text)).ToString();
                        lblResultDisplay.Text = value1 + " " + operation + " " + "log" + "(" + lblEntry.Text + ")";
                        lblEntry.Text = value2;
                    }
                ...
                else if (result != "")
                {
                    ...
                    else
                    {
                        if (entryHasChanged)
                        {
                            result = Math.Log10(Convert.ToSingle(lblEntry.Text)).ToString();
                            value1 = result;
                            lblResultDisplay.Text = "log" + "(" + lblEntry.Text + ")";
                        }
                        else
                        {
                            result = Math.Log10(Convert.ToSingle(result)).ToString();
        ...
        private void btnNaturalLog_Click(object sender, EventArgs e)
        {
            if (value1 == "" && result == "")
            {
                ...
                {
                    result = LOG_OF_ZERO_ERROR_INVALID;
                    lblResultDisplay.Text = "ln" + "(" + lblEntry.Text + ")";
                    lblEntry.Text = result;
                    btnSecond.Enabled = btnPI.Enabled = btnE.Enabled = btnSquare.Enabled = btnOneDivideByX.Enabled = btnAbs.Enabled = btnExponent.Enabled = btnMod.Enabled = btnSquareRoot.Enabled = btnOpenParenteshis.Enabled = btnCloseParenteshis.Enabled = btnFatorial.Enabled = btnPlusMinus.Enabled = btnDecimalPoint.Enabled = btnMPlus.Enabled = btnMMinus.Enabled = btnMs.Enabled = btnDivision.Enabled = btnMultiplication.Enabled = btnSubtraction.Enabled = btnAddition.Enabled = btnXPowerY.Enabled = btnTenPowerX.Enabled = btnLog.Enabled = btnNaturalLog.Enabled = btnTwoPowerX.Enabled = btnCube.Enabled = false;
                    btnSecond.ForeColor = btnPI.ForeColor = btnE.ForeColor = btnSquare.ForeColor = btnOneDivideByX.ForeColor = btnAbs.ForeColor = btnExponent.ForeColor = btnMod.ForeColor = btnSquareRoot.ForeColor = btnOpenParenteshis.ForeColor = btnCloseParenteshis.ForeColor = btnFatorial.ForeColor = btnPlusMinus.ForeColor = btnDecimalPoint.ForeColor = btnMPlus.ForeColor = btnMMinus.ForeColor = btnMs.ForeColor = btnDivision.ForeColor = btnMultiplication.ForeColor = btnSubtraction.ForeColor = btnAddition.ForeColor = btnXPowerY.ForeColor = btnTenPowerX.ForeColor = btnLog.ForeColor = btnNaturalLog.ForeColor = btnTwoPowerX.ForeColor = btnCube.ForeColor = Color.DimGray;
                    btnClear.Visible = true;
                ...
                {
                    lblResultDisplay.Text = "ln" + "(" + lblEntry.Text + ")";
                    lblEntry.Text = Math.Log(Convert.ToSingle(lblEntry.Text)).ToString();
                }
            ...
            else
            {
                if ((value1 != "" && result == ""))
                {
                    ...
                    {
                        value2 = Math.Log(Convert.ToSingle(lblEntry.Text)).ToString();
                        lblResultDisplay.Text = value1 + " " + operation + " " + "ln" + "(" + lblEntry.Text + ")";
                        lblEntry.Text = value2;
                    }
                ...
                else if (result != "")
                {
                    ...
                    else
                    {
                        if (entryHasChanged)
                        {
                            result = Math.Log(Convert.ToSingle(lblEntry.Text)).ToString();
                            value1 = result;
                            lblResultDisplay.Text = "ln" + "(" + lblEntry.Text + ")";
                        }
                        else
                        {
                            result = Math.Log(Convert.ToSingle(result)).ToString();
        ...
        {
            if (btnSquare.Visible)
            {
                btnCube.Visible = btnCubeRoot.Visible = btnYRootX.Visible = btnTwoPowerX.Visible = btnLogYPowerX.Visible = btnEPowerX.Visible = true;
                btnSquare.Visible = btnSquareRoot.Visible = btnXPowerY.Visible = btnTenPowerX.Visible = btnLog.Visible = btnNaturalLog.Visible = false;
            }
            else
            {
                btnCube.Visible = btnCubeRoot.Visible = btnYRootX.Visible = btnTwoPowerX.Visible = btnLogYPowerX.Visible = btnEPowerX.Visible = false;
                btnSquare.Visible = btnSquareRoot.Visible = btnXPowerY.Visible = btnTenPowerX.Visible = btnLog.Visible = btnNaturalLog.Visible = true;
            }
            
        }

        private void btnTwoPowerX_Click(object sender, EventArgs e)
        {
            if (value1 == "" && result == "")
            {
                lblResultDisplay.Text = 2 + "^" + "(" + lblEntry.Text + ")";
                lblEntry.Text = (Math.Pow(2, Convert.ToSingle(lblEntry.Text))).ToString();
            ...
            else
            {
                if ((value1 != "" && result == ""))
                {
                    value2 = (Math.Pow(2, Convert.ToSingle(lblEntry.Text))).ToString();
                    lblResultDisplay.Text = value1 + " " + operation + " " + 2 + "^" + "(" + lblEntry.Text + ")";
                    lblEntry.Text = value2;
                ...
                else if (result != "")
                {
                    ...
                    if (entryHasChanged)
                    {
                        result = (Math.Pow(2, Convert.ToSingle(lblEntry.Text))).ToString();
                        value1 = result;
                        lblResultDisplay.Text = 2 + "^" + "(" + lblEntry.Text + ")";
                    }
                    else
                    {
                        result = (Math.Pow(2, Convert.ToSingle(result))).ToString();
        ...
        private void btnCube_Click(object sender, EventArgs e)
        {
            if (value1 == "" && result == "")
            {
                ...
                lblResultDisplay.Text = "cube" + "(" + lblEntry.Text + ")";
                lblEntry.Text = (Convert.ToSingle(lblEntry.Text) * Convert.ToSingle(lblEntry.Text) * Convert.ToSingle(lblEntry.Text)).ToString() ;
            ...
            else
            {
                if ((value1 != "" && result == ""))
                {
                    value2 = (Convert.ToSingle(lblEntry.Text) * Convert.ToSingle(lblEntry.Text) * Convert.ToSingle(lblEntry.Text)).ToString();
                    lblResultDisplay.Text = value1 + " " + operation + " " + "cube" + "(" + lblEntry.Text + ")";
                    lblEntry.Text = value2;
                ...
                else if (result != "")
                {
                    if (value2 == "")
                    {
                        ...
                        {
                            value1 = result;
                            result = (Convert.ToSingle(result) * Convert.ToSingle(lblEntry.Text) * Convert.ToSingle(lblEntry.Text)).ToString();
                            lblResultDisplay.Text = value1 + " " + operation + " " + "cube" + "(" + lblEntry.Text + ")";
                            value2 = (Convert.ToSingle(lblEntry.Text) * Convert.ToSingle(lblEntry.Text) * Convert.ToSingle(lblEntry.Text)).ToString();
                        }
                        else
                    ...
                    else
                    {
                        if (entryHasChanged)
                        {
                            result = (Convert.ToSingle(lblEntry.Text) * Convert.ToSingle(lblEntry.Text) * Convert.ToSingle(lblEntry.Text)).ToString();
                            value1 = result;
                            lblResultDisplay.Text = "cube" + "(" + lblEntry.Text + ")";
                        }
                        else
                        {
                            ...
                            result = (Convert.ToSingle(result) * Convert.ToSingle(result) * Convert.ToSingle(result)).ToString();
                            lblResultDisplay.Text = "cube" + "(" + lblEntry.Text + ")";
                        }
                    }
        ...
        {
            if (lblEntry.Text == DIVIDE_BY_ZERO_ERROR || lblEntry.Text == DIVIDE_BY_ZERO_ERROR_UNDEFINED || lblEntry.Text == LOG_OF_ZERO_ERROR_INVALID)
            {
                return true;
            }
            return false;
